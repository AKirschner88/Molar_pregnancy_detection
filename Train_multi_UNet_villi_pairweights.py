...
class Criterion(nn.Module):
    ...
    def forward(self, x_pred, y, weight_map):
        loss_matrix = self.critCEntropy(x_pred, y)      # shape [B, H, W]
        lossCEntropy = (loss_matrix * weight_map).mean()
        return (lossCEntropy,)
...
table = "AKV11_img9_-75_data_villi_multi"
dataname = 'AKV26_data_villi_multi' 
...
criterion = Criterion(class_weight) 
