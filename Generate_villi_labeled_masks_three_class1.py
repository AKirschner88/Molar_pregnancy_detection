...
image_numbers = [1]  # Add more if needed
...
for img_num in image_numbers:
    ...
    json_fname_polygons = f'E:\Digital_Pathology\Project\Aron_to_share\Annotations\DP000020{str(img_num).zfill(2)}.json.gz'
...
version = "AKV7"
distance = "1"
hdf5_train = tables.open_file(fr'E:\Digital_Pathology\Project\Aron_to_share\Datasets\{version}_{distance}_data_villi_multi_train.pytable', mode='w', filters=filters)
hdf5_test = tables.open_file(fr'E:\Digital_Pathology\Project\Aron_to_share\Datasets\{version}_{distance}_data_villi_multi_test.pytable', mode='w', filters=filters)
